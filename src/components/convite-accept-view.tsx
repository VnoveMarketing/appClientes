...
import { normalizeConviteToken } from "@/lib/convite";
...
type ConviteAcceptViewProps = {
  rawToken: string;
};

export function ConviteAcceptView({ rawToken }: ConviteAcceptViewProps) {
  const router = useRouter();
  const token = normalizeConviteToken(rawToken);
          ...
          {loadingConvite ? (
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-xs text-zinc-500">
                Se o link não funcionar, solicite um novo convite ao administrador do sistema.
              </p>
              <Button
                type="button"
                variant="outline"
